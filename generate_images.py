...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        progress = ""
        lang_list = ""
        for name, data in sorted_langs[:5]:
            ...
            lang_list += f'<li><svg class="octicon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8z"></path></svg><span class="lang">{name}</span><span class="percent">{prop:.1f}%</span></li>\n'
